...
public class QA_IPHONE__Page extends TESTBASE_{
	...
	public QA_IPHONE__Page(WebDriver driver) throws FileNotFoundException {
		PageFactory.initElements((TESTBASE_.driver), this);
	}
	
	public static void getpage_title_iphone()
	{
		System.out.println((TESTBASE_.driver).findElement(By.xpath("//h2")).getText());
		}
		
	public static  QA_WATCH__Page to_watchpage() throws FileNotFoundException
	{
		Watch_page.click();
		return new QA_WATCH__Page(driver);
		}
	}
